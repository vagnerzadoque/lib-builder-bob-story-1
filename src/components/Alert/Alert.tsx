...
export const AlertPropsDefault: AlertProps = {
    testID : 'alert',
    variant : 'standard',
    type : 'info',
    icon : true,
  ...
  return (
    ...
    >
      <IconContent testID={`${testID}-icon`}>
        {icon && <GayaIcon color={isAlertCustom(props) ? props.iconColorName : 'neutral900'} name={isAlertCustom(props) ? props.iconName : getIcon(type).name}  />}
      </IconContent>
