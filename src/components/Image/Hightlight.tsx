...
type FadeProps =  Pick<ImageBaseProps, 'fade' | 'variant' | 'source'>

type fadeProp = 'left' | 'top' | 'right' | 'bottom' | undefined

export const getFadePosition = (fade:fadeProp = 'left') => {
  const positions = {
    left: {
      x1: '1', y1: '0', x2: '0', y2: '0'
    },
